...
<svg xmlns="http://www.w3.org/2000/svg" width="480" height="166" class="">
    <defs>
        <style/>
    </defs>
        ...
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    ...
                    <rect mask="url(#languages-bar)" x="0" y="0" width="149.18113034634598" height="8" fill="#e34c26"/>
                    <rect mask="url(#languages-bar)" x="149.18113034634598" y="0" width="137.90689824178932" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="287.08802858813533" y="0" width="67.0301713376253" height="8" fill="#f1e05a"/>
                    <rect mask="url(#languages-bar)" x="354.1181999257606" y="0" width="37.08238088195578" height="8" fill="#663399"/>
                    <rect mask="url(#languages-bar)" x="391.2005808077164" y="0" width="29.618318142396195" height="8" fill="#4F5D95"/>
                    <rect mask="url(#languages-bar)" x="420.81889895011255" y="0" width="22.036911150677003" height="8" fill="#3572A5"/>
                    <rect mask="url(#languages-bar)" x="442.8558101007896" y="0" width="12.161127049951872" height="8" fill="#00B4AB"/>
                    <rect mask="url(#languages-bar)" x="455.01693715074146" y="0" width="4.983062849258545" height="8" fill="#b07219"/>
                </svg>
